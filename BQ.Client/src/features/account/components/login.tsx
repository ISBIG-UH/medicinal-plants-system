...
import OverlayInputError from "../../../components/overlay-error/overlay-input-error";
...
const Login: React.FC = () => {
    ...
    return <div className="flex justify-center items-center h-screen bg-leaf-wall">
            <div className="border w-full max-w-96 border-gray-300 rounded-lg p-8 mx-8 bg-primary">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex flex-col gap-2 font-quicksand">
                        ...
                        <div>
                            <label htmlFor="email" className="font-sniglet text-secondary block">Correo electrónico</label>
                        ...
                        <div>
                            <label htmlFor="password" className="font-sniglet text-secondary block">Contraseña</label>
